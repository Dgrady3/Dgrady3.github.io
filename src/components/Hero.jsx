    ...
    return (
      <section className="min-h-screen flex items-center justify-center relative">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="font-mono text-4xl font-bold text-white mb-2">Joe Grady</h1>
          ...
          <div className="flex items-center justify-center gap-4">
            <button
              ...
              className="px-5 py-2.5 bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 font-mono text-xs rounded hover:bg-cyan-500/20 transition-all"
            >
              View Projects
            </button>
            <button
              onClick={() => scrollTo('contact')}
              className="px-5 py-2.5 border border-white/10 text-gray-400 font-mono text-xs rounded hover:border-white/20 transition-all"
            >
              Get in Touch
            </button>
          </div>
